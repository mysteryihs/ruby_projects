...
bottles = 9999
while bottles != 0
  puts englishNumber(bottles) + ' bottles of beer on the wall, ' + englishNumber(bottles) + ' of beer'
  bottles -= 1
  puts 'Take one down, pass it around ' + englishNumber(bottles) + ' bottles of beer on the wall'
end